      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 shadow-md rounded-xl hover:shadow-lg transition">
            <h2 className="text-2xl font-bold mb-2 text-gray-800">Users</h2>
            <p className="text-gray-600 mb-4">
              View & add system users.
            </p>
            <Link
          ...
          <div className="bg-white p-6 shadow-md rounded-xl hover:shadow-lg transition">
            ...
            <p className="text-gray-600 mb-4">
              View all financial invoices & billing history.
            </p>
            <Link
              href="/admin-dashboard/invoice-history"
          ...
          <div className="bg-white p-6 shadow-md rounded-xl hover:shadow-lg transition">
            ...
            <p className="text-gray-600 mb-4">
              Monitor available products & pricing.
            </p>
            <Link
